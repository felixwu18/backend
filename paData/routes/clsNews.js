...
module.exports = function (req, res) {
    ...
    // const updateTime = String(new Date('2021-01-11 18:01').getTime()).slice(0, -3) * 1 // 制定最新时间，向过去时间截取
    ...
    download(url, data => {
        ...
        const condition = "item.content.search('电子') !== -1 || item.author_extends.search('华友钴业') !== -1"
        ...
        // console.log(temp, `duqu--${temp.length}--获取财联社数据成功！`)
      }, 1)
}