...
module.exports = function (req, res) {
    const bankuaiFileName = '化工行业'
    const writePath = `F:\\stock\\backend2\\paData\\data\\bankuaiParts\\${bankuaiFileName}.js`; //生成目录文件
    const { size = 500, current = 1, bkid = 'BK0538', updateTime: _ = Date.now() } = req.query;
    /* 板块个股 */
